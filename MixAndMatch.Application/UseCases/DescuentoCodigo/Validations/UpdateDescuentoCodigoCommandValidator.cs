...
public class UpdateDescuentoCodigoCommandValidator : AbstractValidator<UpdateDescuentoCodigoCommand>
{
    public UpdateDescuentoCodigoCommandValidator()
    {
        RuleFor(x => x.DescuentoCodigoId)
            .GreaterThan(0).WithMessage("El id del descuento de código debe ser mayor que cero.");
