...
public class UpdateDatosEnvioCommandValidator : AbstractValidator<UpdateDatosEnvioCommand>
{
    public UpdateDatosEnvioCommandValidator()
    {
        RuleFor(x => x.DatosEnvioId).GreaterThan(0).WithMessage("El id de los datos de envio debe ser mayor que cero.");
