...
public class UpdatePrendaImagenCommandValidator : AbstractValidator<UpdatePrendaImagenCommand>
{
    public UpdatePrendaImagenCommandValidator()
    {
        RuleFor(x => x.PrendaImagenId)
            .GreaterThan(0).WithMessage("El id de la imagen de prenda debe ser mayor que cero.");
