...
public class UpdateDescuentoCategoriaCommandValidator : AbstractValidator<UpdateDescuentoCategoriaCommand>
{
    public UpdateDescuentoCategoriaCommandValidator()
    {
        RuleFor(x => x.DescuentoCategoriaId)
            .GreaterThan(0).WithMessage("El id del descuento de categoria debe ser mayor que cero.");
